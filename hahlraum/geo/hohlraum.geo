...
//+
Point(26) = {0, -6.5, 0, 1.0};
//+
Point(27) = {1, -6.5, 0, 1.0};
//+
Point(28) = {1.5, -6.5, 0, 1.0};
//+
Point(29) = {5.5, -6.5, 0, 1.0};
//+
Point(30) = {9, -6.5, 0, 1.0};
//+
Point(31) = {9.5, -6.5, 0, 1.0};
//+
Point(32) = {13.5, -6.5, 0, 1.0};
//+
Point(33) = {14, -6.5, 0, 1.0};
//+
Point(34) = {14, -6, 0, 1.0};
//+
Point(35) = {13.5, -6, 0, 1.0};
//+
Point(36) = {9.5, -6, 0, 1.0};
//+
Point(37) = {5, -6, 0, 1.0};
//+
Point(38) = {5.5, -6, 0, 1.0};
//+
Point(39) = {1, -6, 0, 1.0};
//+
Point(40) = {1.5, -6, 0, 1.0};
//+
Point(41) = {0, -6, 0, 1.0};
