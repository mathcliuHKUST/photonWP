...
module global_data
    ...
    character(len=20),parameter :: RSTFILENAME = "photonwp.vtk" !result file name
    !direction
    ...
    !group
    integer,parameter :: cell01 = -1  !ghost cell
    integer,parameter :: cell02 = -2  !ghost cell
    integer,parameter :: cell11 = -3  !inner cell
    integer,parameter :: cell12 = -4  !inner cell
    integer,parameter :: cell13 = -5  !inner cell
    integer,parameter :: cell14 = -6  !inner cell
    integer,parameter :: cell15 = -7  !inner cell
    integer,parameter :: face0  = -8  !boundary 
    integer,parameter :: face1  = -9  !inner
    integer,parameter :: node0  = -10 !boundary
    integer,parameter :: node1  = -11 !inner
    ...
    type :: node_type
        ...
        integer :: ref_id
        integer :: cell_number
        integer :: cell_id(1:100)
        real(kind=double) :: coords(1:3)
        real(kind=double) :: coords_c(1:3)
    end type node_type
    ...
    type :: face_type
        ...
        integer :: cell_id(1:2)
        !geometry
        real(kind=double) :: coords(1:3) !face center coordinates
        real(kind=double) :: area !area of cell interface
        !normal direction
        real(kind=double) :: norm(1:3)
        real(kind=double) :: weight(1:3) !projection of norm direction
        !field
    ...
    type :: cell_type
        ...
        integer :: face_number
        !geometry
        real(kind=double) :: volume !cell volume
        real(kind=double) :: coords(3) !cell center coordinates
        !flow field
    ...
    type :: particle_type
        ...
        real(kind=double) :: x(1:3) !position
        real(kind=double) :: x_new(1:3) !position
        real(kind=double) :: v(1:3) !velocity
